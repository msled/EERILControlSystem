...
namespace EERIL.DeviceControls
{
    public class HeadUpDisplay : Canvas
    {
        ...
        private Geometry pitchGaugeClippingGeometry = new RectangleGeometry();
        private Geometry falseHorizonClippingGeometry = new RectangleGeometry();
        private readonly AccelerationBasedLocation location = new AccelerationBasedLocation();
        ...
        public double Pitch
        {
            ...
            set
            {
                invertedPitchTransform.Y = (pitchTransform.Y = (value + PitchOffset) * ratioToDisplayAngleMultiplier) * -1;
                InvalidateVisual();
            }
        }
        ...
        public IProducerConsumerCollection<AccelerationSample> AccelerationSamples
        {
            get {
        ...
        public HeadUpDisplay() {
            location.ValuesUpdated += LocationOnValuesUpdated;
        }

        private void LocationOnValuesUpdated(object sender, EventArgs eventArgs) {
            mapScale = location.FurthestDistance / mapRadius;
            locationTranslateTransform.X = location.Distance.X * mapScale;
            locationTranslateTransform.Y = location.Distance.Y * mapScale;
            InvalidateVisual();
        }
        ...
        protected override void OnRender(DrawingContext context)
        {
            ...
            RenderGauge(context, Math.Round(Fps, 2), 1, fpsFormattedText);
        ...
        protected override void OnRenderSizeChanged(SizeChangedInfo sizeInfo)
        {
            ...
            pitchGaugeClippingGeometry = maxInnerClippingRectangle.Clone();
            pitchGaugeClippingGeometry.Transform = new TransformGroup{
                Children = new TransformCollection{
                    invertedRollTransform,
                    invertedPitchTransform
                }
            };
            pitchGauge.ClipGeometry = pitchGaugeClippingGeometry;

            falseHorizonClippingGeometry = maxInnerClippingRectangle.Clone();
            falseHorizonClippingGeometry.Transform = invertedRollTransform;
            falseHorizonCrosshairs.ClipGeometry = falseHorizonClippingGeometry;
        ...
        protected void RenderMap(DrawingContext context) {
            if(baselinePen == null) {
                return;
            }
            context.DrawGeometry(null, mapPen, mapGeometryGroup);
        }
